      ...
      <CardHeader className="p-0 relative top-0 space-y-0">
        <div className="icons absolute top-3 right-3 flex flex-col justify-center items-center">
          <button
            ...
            className="bg-white/90 text-[#4E1B61] w-10 h-10 rounded-full text-sm font-medium hover:bg-[#4E1B61] hover:text-white duration-150 ease-in-out transition-all grid place-items-center relative"
          >
            {isInWishlist ? (
